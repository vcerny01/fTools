...
namespace IO.Swagger.CzechPost.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ParcelPrintingRequest :  IEquatable<ParcelPrintingRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ParcelPrintingRequest" /> class.
        /// </summary>
        /// <param name="printingHeader">printingHeader (required).</param>
        /// <param name="printingData">printingData (required).</param>
        public ParcelPrintingRequest(PrintingHeader printingHeader = default(PrintingHeader), PrintingData printingData = default(PrintingData))
        {
            // to ensure "printingHeader" is required (not null)
            if (printingHeader == null)
            {
                throw new InvalidDataException("printingHeader is a required property for ParcelPrintingRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("printingData is a required property for ParcelPrintingRequest and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ParcelPrintingRequest {\n");
        ...
        {
            return this.Equals(input as ParcelPrintingRequest);
        }

        /// <summary>
        /// Returns true if ParcelPrintingRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ParcelPrintingRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ParcelPrintingRequest input)
        {
            if (input == null)
                return false;
